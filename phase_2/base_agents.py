...
class RAGKnowledgePromptAgent:
    """
    An agent that uses Retrieval-Augmented Generation for dynamic knowledge.
    NOTE: The implementation for this agent is provided.
    """
    def __init__(self, openai_api_key, knowledge_base):
        # Implementation as provided in the course materials.
        pass
